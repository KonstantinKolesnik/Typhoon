    ...
    public class DockPanel : Panel
    {
        ...
        protected override void ArrangeOverride(int arrangeWidth, int arrangeHeight)
        {
            ...
            for (int i = 0; i < totalChildrenCount; i++)
            {
                ...
                int finalWidth = System.Math.Max(0, arrangeWidth - accumulatedLeft - accumulatedRight);
                int finalHeight = System.Math.Max(0, arrangeHeight - accumulatedTop - accumulatedBottom);
                ...
                if (i < nonFillChildrenCount)
                    switch (DockPanel.GetDock(child))
                    {
                        ...
                        case Dock.Right:
                            ...
                            finalX = System.Math.Max(0, arrangeWidth - accumulatedRight);
                            finalWidth = desiredWidth;
                            break;

                        case Dock.Bottom:
                            accumulatedBottom += desiredHeight;
                            finalY = System.Math.Max(0, arrangeHeight - accumulatedBottom);
                            finalHeight = desiredHeight;
                            break;
                    }
        ...
        protected override void MeasureOverride(int availableWidth, int availableHeight, out int desiredWidth, out int desiredHeight)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                int childAvailableWidth = System.Math.Max(0, availableWidth - accumulatedWidth);
                int childAvailableHeight = System.Math.Max(0, availableHeight - accumulatedHeight);
                ...
                switch (DockPanel.GetDock(child))
                {
                    case Dock.Left:
                    case Dock.Right:
                        desiredHeight = System.Math.Max(desiredHeight, accumulatedHeight + childDesiredHeight);
                        accumulatedWidth += childDesiredWidth;
                        break;
                    case Dock.Top:
                    case Dock.Bottom:
                        desiredWidth = System.Math.Max(desiredWidth, accumulatedWidth + childDesiredWidth);
                        accumulatedHeight += childDesiredHeight;
                        break;
                }
            }

            desiredWidth = System.Math.Max(desiredWidth, accumulatedWidth);
            desiredHeight = System.Math.Max(desiredHeight, accumulatedHeight);
        }
        ...
        public static void SetDock(UIElement element, Dock dock)
        {
            ...
            if (index == -1)
            {
                index = DockPropertiesKeys.Add(element);
