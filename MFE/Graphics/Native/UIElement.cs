...
namespace MFE.Graphics.Native
{
    public abstract class UIElement
    {
        ...
        {
            SetMargin(leftright, topbottom, leftright, topbottom);
        }
                                            ...
                                            out int dx, out int dy)
        {
            ...
            if (ha == HorizontalAlignment.Stretch && arrangeWidth > clientWidth)
                ha = HorizontalAlignment.Left;
            if (va == VerticalAlignment.Stretch && arrangeHeight > clientHeight)
        ...
        {
            get { return (_flags & Flags.InvalidMeasure) == 0; }
        }
        ...
        {
            get { return (_flags & Flags.InvalidArrange) == 0; }
        }
        ...
        public MSPresentation.HorizontalAlignment HorizontalAlignment
        {
            get
            {
        ...
        public MSPresentation.VerticalAlignment VerticalAlignment
        {
            get
            {
        ...
        ///     Visibility accessor
        /// </summary>
        public MSPresentation.Visibility Visibility
        {
            get
            {
                return _visibility;
            ...
            set
            {
                if (_visibility != value)
                {
                    ...
                    bool invalidateMeasure = (_visibility == MSPresentation.Visibility.Collapsed || value == MSPresentation.Visibility.Collapsed);
                    ...
                    if (parentVisible && value == MSPresentation.Visibility.Visible)
                    {
        ...
        {
            get { return (_flags & Flags.IsVisibleCache) != 0; }
        }
        ...
        private MSPresentation.Visibility _visibility;
        ...
        protected MSPresentation.HorizontalAlignment _horizontalAlignment;
        protected MSPresentation.VerticalAlignment _verticalAlignment;
