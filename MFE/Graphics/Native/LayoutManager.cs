...
namespace MFE.Graphics.Native
{
    ...
    internal class LayoutManager
    {
        ...
        private MfeDispatcherOperationCallback _updateLayoutBackground;
        private MfeDispatcherOperationCallback _updateCallback;
        #endregion
        ...
        private LayoutManager()
        {
            ...
            _updateLayoutBackground = new MfeDispatcherOperationCallback(UpdateLayoutBackgroundCallback);
            _updateCallback = new MfeDispatcherOperationCallback(UpdateLayoutCallback);
        ...
        public void UpdateLayout()
        {
            ...
            finally
            {
                ...
                if (gotException)
                {
                    ...
                    //MfeDispatcher.BeginInvoke(_updateLayoutBackground, this);
                    UpdateLayoutBackgroundCallback(this);
                }
            }
        }
        ...
        private object UpdateLayoutBackgroundCallback(object arg)
        {
            NeedsRecalc();
            return null;
        }
        ...
        private void getProperArrangeRect(UIElement element, out int x, out int y, out int width, out int height)
        {
            ...
            if (element.Parent == null)
            {
                ...
                if (element._previousAvailableWidth == Microsoft.SPOT.Presentation.Media.Constants.MaxExtent)
                    width = desiredWidth;

                if (element._previousAvailableHeight == Microsoft.SPOT.Presentation.Media.Constants.MaxExtent)
