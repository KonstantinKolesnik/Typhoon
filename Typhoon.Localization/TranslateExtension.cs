...
namespace Typhoon.Localization
{
    ...
    public class Translate : MarkupExtension
    {
        ...
        //public static readonly DependencyProperty UidProperty = DependencyProperty.RegisterAttached("Uid", typeof(string), typeof(Translate), new PropertyMetadata(string.Empty));
        #endregion
