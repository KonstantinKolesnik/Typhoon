/*
#ifndef __HARDWAREOLD_H__
#define __HARDWAREOLD_H__
...
// if changed: check timings, timer settings, baudrate
...
#elif (__AVR_ATTiny2313___)
  // attiny2313:   128Byte SRAM, 128Byte EEPROM
  ...
  #define EEPROM_BASE  0x810000L
#else
  #warning: no supported processor  
#endif
...
#define JUMPER1_SET    (!(PIND & (1<<JUMPER1)))
#define JUMPER2_SET    (!(PIND & (1<<JUMPER2)))
...
#define S88_CLK_HIGH     PORTB |= (1<<S88_CLK)
#define S88_CLK_LOW      PORTB &= ~(1<<S88_CLK)
